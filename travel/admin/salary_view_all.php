...
<link rel="stylesheet" href="css/bar.css" type="text/css" />
  ...
  <p class="ph2"><a href="index.php">home&gt;&gt;</a><a href="employee_view.php">Employee View&gt;&gt;</a><a href="salary_view.php?emp_id=<?php echo $_GET['emp_id'];?>">Salary view</a></p>
  ...
  <tr>
    ...
    <td><?php       echo $employee; ?></td>
     <td><?php       echo $date; ?></td>
      ...
      <td><?php $cID=$inserted_by; $s=mysqli_query("SELECT * FROM admin WHERE user_id='$cID'");  

...
<td align="left" valign="top">
  ...
  <td width="74" class="asad" >Salary</td>
    <td width="71" ><a href="Salary1.php?emp_name=<?php echo $emp_name;?>"><i class="fa fa-plus-square"></i></a>/<a href="salary_view.php?emp_name=<?php echo $emp_name;?>"><img src="images/icon_view_new.gif" title="View Salary" /></a></td>
  </tr>

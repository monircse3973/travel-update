...
$sql="insert into employee (emp_picture, emp_name, emp_contact,emp_email, emp_address, emp_reference, emp_join, emp_close, emp_desc) values('$uploadimage', '$emp_name', '$emp_contact','$emp_email', '$emp_address', '$emp_reference', '$emp_join', '$emp_close', '$emp_desc')" or die(mysqli_error());

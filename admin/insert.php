...
$payment_id=getMaxID('payment_id','payment');
 ...
 $result = mysqli_query($con,"INSERT INTO transaction(cashID,paymentID) VALUES ('$maxCashID', '$payment_id')" ) or die("Error in salary Query :: ".mysqli_error($con));
 		 	 	 		 	 	...
 		 	 	 		 	 	
{
 ...
 $maxCashID=getMaxID('cashID','cash');
$result =  mysqli_query($con,"INSERT INTO transaction(cashID, expenseID) VALUES ('$maxCashID', '$voucher_no')" );
 if($result)
	{ echo"data is inserted successfully";
...
if(isset($_POST["daily_expenses"]))
{
 ...
 insertCash($amount,"Cr",$description);
 $maxCashID=getMaxID('cashID','cash');
$result =  mysqli_query($con,"INSERT INTO transaction(cashID, expenseID) VALUES ('$maxCashID', '$id')" ) or die("Error".mysqli_error($con));
...
if(isset($_POST["salaryform"]))
{
 ...
 $maxCashID=getMaxID('cashID','cash');
 $result = mysqli_query($con,"INSERT INTO transaction(cashID,salaryID) VALUES ('$maxCashID', '$salary_id')" ) or die("Error in salary Query :: ".mysqli_error($con));

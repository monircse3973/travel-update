...
?>
<body>
<div id="loading" class="ui-front loader ui-widget-overlay bg-white opacity-100" align="center"> <img src="../css/" alt="" /> </div>
<div id="page-content-wrapper">
  <div id="page-title">
    <h1 align="center"> ATC tech Travel Agency Bill </h1>
  </div>
  <!-- #page-title -->

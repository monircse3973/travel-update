...
<div class="container">
	<div class="row">
		<div class="col-md-4 col-md-offset-3">
			...
			Customer Name Or Contact No:<input type="text" class="form-control" name="customer_name" />
			<input type="submit" class="seacrh-btn" style="position: absolute;
    top: 19px;
    /* left: 0; */
    /* bottom: 0; */
    right: -65px;

...
<tr>
 ...
 <td><?php $cID=$inserted_by; $s=mysqli_query($con,"SELECT * FROM admin WHERE user_id='$cID'");  
  $d=mysqli_fetch_array($s);
   echo $d['username']; ?></td>
     <td><?php /*?><a href="document_edit.php?document_id=<?php echo $document_id;?>"><img src="images/edit.png" title="Edit document" /></a><?php */?>&nbsp;&nbsp;<a href="delete.php?document_id=<?php echo $document_id ;?>" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash" title="Delete Doucument"></i></a></td>

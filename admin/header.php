...
<meta charset="utf-8" />
    ...
    <link rel="stylesheet" type="text/css" href="login1/css/footer.css">
    <!--  Pretty Photo Style -->
    ...
    <!--  Google Font Style -->
     ...
     <!-- Bootstrap core CSS -->
    <link href="cus_css/bootstrap.min.css" rel="stylesheet">
    <link href="cus_css/bootstrap-reset.css" rel="stylesheet">
    <!--external css-->
    <link href="assets/font-awesome/css/font-awesome.css" rel="stylesheet" />
    <link href="cus_css/table-responsive.css" rel="stylesheet" />
      <!--right slidebar-->
      <link href="cus_css/slidebars.css" rel="stylesheet">
    <!-- Custom styles for this template -->
    <link href="cus_css/style.css" rel="stylesheet">
    <link href="cus_css/style-responsive.css" rel="stylesheet" />
...
<div class="container-fluid">
  <div class="row">
    <div class="" id="header" class="full-width-bg">
      
    </div>
  </div>
</div>
<div class="full-width-bg" style="
    height: 200px;
">
